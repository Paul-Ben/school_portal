...
class LocalGovernmentAreasTableSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
       ...
       ['name' =>  "Makurdi", 'state_id' => 7],
        ...
        ['name' => "Edda",'state_id' => 11],
        ['name' => "Afikpo",'state_id' => 11],
       ...
       ['name' =>  "Ringim", 'state_id' => 18],
        ...
        ['name' =>  "Yewa North", 'state_id' => 28], 
        ['name' =>  "Yewa South", 'state_id' => 28], 
